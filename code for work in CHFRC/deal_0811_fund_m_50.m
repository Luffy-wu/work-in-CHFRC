function deal_0811_fund_m_50()
[~,txt,raw]=xlsread('C:\Users\asus\Desktop\实习luffy1\0727\指数基金.xls','huaxia50');   %以上证50为例
...
% syms y;
% eq=1015*((1+y)^(j-1)-1)/y-b*(1-0.01*0.134); %20170731xiugai
% y=solve(eq,'y');
% ans=double(y);
% ans=ans(~logical(imag(ans)));
% c2=ans(ans>0);

xlswrite('C:\Users\asus\Desktop\实习luffy1\0727\huaxia50_m.xls',data_out,'sheet1');
xlswrite('C:\Users\asus\Desktop\实习luffy1\0727\huaxia50_m.xls',c,'sheet2');
% xlswrite('C:\Users\asus\Desktop\实习luffy1\0727\huaxia50_m.xls',c2,'sheet3');